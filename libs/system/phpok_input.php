...
class phpok_input_lib
{
	...
	function _FckExt($inputname,$subnote="",$width="690px")
	{
		...
		$msg.= "<td style='text-align:right;width:44px;'><input type='button' value='分页' class='btn2' onclick=\"phpjs_fck_page('".$inputname."')\" style='width:40px;'></td>";
		...
		$msg.= "<td style='text-align:right;width:44px;'><input type='button' value='附件' class='btn2' onclick=\"phpjs_fck_download('".$inputname."')\" style='width:40px;'></td>";
		$msg.= "<td style='text-align:right;width:44px;'><input type='button' value='影音' class='btn2' onclick=\"phpjs_fck_video('".$inputname."')\" style='width:40px;'></td>";
		$msg.= "</tr></table></div>";
		return $msg;
	}
}
