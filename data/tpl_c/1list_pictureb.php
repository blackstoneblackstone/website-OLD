...
<div class="main">
 ...
 <div style="background:url(tpl/www/images/42.jpg) no-repeat; width:145px; height:36px; line-height:36px; color:#fff; font-family:'微软雅黑'; font-size:18px; font-weight:bold; padding-left:45px;"><?php echo $hotpic[me][cate_name];?></div>
 <?php $_i=0;$hotpic[rslist]=(is_array($hotpic[rslist]))?$hotpic[rslist]:array();foreach($hotpic[rslist] AS  $key=>$value){$_i++; ?>
 ...
 <div style=" margin-top:25px;">  <?php $hotpic = phpok("xg");?>
 <div style=" background:url(tpl/www/images/43.jpg) no-repeat; height:31px; line-height:31px; padding-left:15px; color:#FFF; font-size:16px; font-weight:bold;"><?php echo $hotpic[me][cate_name];?></div>

 <ul><?php $_i=0;$hotpic[rslist]=(is_array($hotpic[rslist]))?$hotpic[rslist]:array();foreach($hotpic[rslist] AS  $key=>$value){$_i++; ?>
 <li style="margin-top:15px;">
 <div style="float:left; width:400px;">
 <div><a href="<?php echo msg_url($value);?>" title="<?php echo $value[title];?>" style="font-size:16px; font-weight:bold; color:#340343;"><?php echo sys_cutstring($value[title],50);?></a></div>
  <div style="width:380px; margin-left:20px; line-height:22px; margin-top:20px; font-family:'微软雅黑';"><?php echo $value[note];?><a href="<?php echo msg_url($value);?>" style=" color:#340343;">查看详细>></a></div>
 </div>
 <div style="float:right;"><a href="<?php echo msg_url($value);?>" title="<?php echo $value[title];?>"><img src="<?php echo $value[picture];?>" border="0" alt="<?php echo $value[title];?>" /></a></div>
 <div class="clear"></div>
 </li><?php } ?>
 </ul>
 <?php unset($hotpic);?>
 </div>
 <div style=" margin-top:25px;"><?php $hotpic = phpok("cg");?>
 <div style=" background:url(tpl/www/images/47.jpg) no-repeat; height:31px;  line-height:31px; padding-left:15px; color:#FFF; font-size:16px; font-weight:bold;"><?php echo $hotpic[me][cate_name];?></div>
 <ul><?php $_i=0;$hotpic[rslist]=(is_array($hotpic[rslist]))?$hotpic[rslist]:array();foreach($hotpic[rslist] AS  $key=>$value){$_i++; ?>
...
<div style=" height:140px;"> <div><a href="<?php echo msg_url($value);?>" title="<?php echo $value[title];?>" style=" font-size:16px; color:#000; font-weight:bold;">【<?php echo $hotpic[me][cate_name];?>】<?php echo sys_cutstring($value[title],50);?></a></div>
